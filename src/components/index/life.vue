  ...
  <div class="m-life">
    <el-row>
      <ul class="nav">
        ...
        <li>
          <router-link to="/" class="takeot">猫眼电影</router-link>
        </li>
        <li>
          <router-link to="/" class="takeot">美团酒店</router-link>
        </li>
        <li>
          <router-link to="/" class="apartment">民宿/公寓</router-link>
        </li>
        <li>
          <router-link to="/" class="busines">商家入驻</router-link>
        </li>
        <li>
          <router-link to="/" class="takeot">美团公益</router-link>
        </li>
      </ul>
    </el-row>
    <el-row>
